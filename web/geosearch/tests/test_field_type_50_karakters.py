...
class TestFieldType50Karakters(unittest.TestCase):
    def test_field_type_50_karakters(self):
        """Test if output field 'type' => product
        of '[dataset_name]/[name]'
        can handle 50 characters"""

        # setup test row with name and dataset_name combined
        # (plus the forward slash) is 50 characters
        ...
        self.assertEqual(
            str(query_result[0]["properties"]["type"]),
            "0123456789-0123456789-12/0123456789-0123456789-123",
        )
