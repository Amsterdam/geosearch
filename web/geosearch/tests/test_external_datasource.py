...
class TestExternalDataSource(unittest.TestCase):
    def test_execute_applies_dataset_filtering(self):
        test_datasource = datasource.ExternalDataSource(
            meta=dict(
        ...
        with unittest.mock.patch(
            "datapunt_geosearch.datasource.ExternalDataSource.fetch_data"
        ) as fetch_mock:
    ...
    def test_fetch_data_formats_search_url_using_base_url(self):
        ...
        self.assertEqual(
            requests_mock.mock_calls,
            [
                unittest.mock.call(
                    "http://localhost:8000/test/search",
        ...
        self.assertEqual(
            ...
            [
                unittest.mock.call.warning(
                    "Failed to fetch data from http://localhost:8000/test/search. Error 'meh.'."  # noqa: E501
                )
            ],
        )
    ...
    def test_format_result_applies_field_mapping(self):
        ...
        result = test_datasource.format_result(
            ...
            result=[
                {
                    "_links": {"self": {"href": "/test/test/129569479969/"}},
                    "id": "129569479969",
                    "geometrie": {"type": "MultiPolygon", "coordinates": []},
                }
            ],
        )
        ...
        self.assertEqual(
            result[0]["properties"]["uri"],
            "http://localhost:8000/test/test/129569479969/",
        )
    ...
    def test_external_datasource_can_be_registered_in_registry(self):
        ...
        test_datasource = test_registry.register_external_dataset(
            name="test", base_url="http://localhost:8000", path="test/geosearch/"
        )
